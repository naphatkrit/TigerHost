...
from tigerhostctl.project import get_project_path, save_project_path, default_project_path
...
def test_without_project_path_default_normal(runner, fake_git_remote):
    ...
    with mock.patch('tigerhostctl.settings.PROJECT_REMOTE', new=fake_git_remote):
